...
namespace SGE.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoUsuarioId"] = new SelectList(_context.TiposUsuario, "TipoUsuarioId", "TipoUsuario");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,UsuarioNome,Email,Senha,Celular,CadAtivo,DataCadastro,CadInativo,TipoUsuarioId")] Usuario usuario)
        {
            ...
            ViewData["TipoUsuarioId"] = new SelectList(_context.TiposUsuario, "TipoUsuarioId", "TipoUsuario", usuario.TipoUsuarioId);
            return View(usuario);
        }
